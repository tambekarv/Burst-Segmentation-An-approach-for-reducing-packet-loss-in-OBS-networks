...
public class ModelBurstExchange extends ModelAnimation {
	...
	protected final double CONTAINER_STORAGE_TIME = 15.0;
	...
	protected final double MEAN_TRUCK_INTER_ARRIVAL_TIME =0.65;
...
public static int k=0;
	...
	BackgroundElementAnimation totalprocessed;
	BackgroundElementAnimation totaldropped;
	...
	//private ContDistExponential distBurstInterArrivalTime;
...
BackgroundElementAnimation[]	text2;
	...
	public void initAnimation() {
		/*
		totalprocessed= new BackgroundElementAnimation(this, "trial1", null, "INPUT", 
					BackgroundElement.TEXT_POSITION_Middle, BackgroundElement.TEXT_Size_Normal,
					BackgroundElement.TEXT_Style_Bold, 0, new Position(-220,200), new Form(100, 29), 
					Color.white, Color.blue, this.animationIsOn());
		totaldropped= new BackgroundElementAnimation(this, "trial1", null, "INPUT", 
				BackgroundElement.TEXT_POSITION_Middle, BackgroundElement.TEXT_Size_Normal,
				BackgroundElement.TEXT_Style_Bold, 0, new Position(-220,230), new Form(100, 29), 
				Color.white, Color.blue, this.animationIsOn());
		...
		*/
		bgElement10= new BackgroundElementAnimation(this, "trial1", null, "", 
				...
				BackgroundElement.TEXT_Style_Bold, 0, new Position(140,140), new Form(840, 80), 
		...
		*/
		...
		segQueue = new ProcessQueueAnimation<Burst>(this, "Deflected Bursts", 
				ProcessQueue.FIFO, 200, this.reportIsOn(), this.traceIsOn());
...
/****  v  *************************************************************************************/
		...
		count.createAnimation(new Position(160, 600), new Form(), this.animationIsOn());
		...
		countSuccesful.createAnimation(new Position(450,600), new Form(), this.animationIsOn());
		
		countUnsuccesful = new CountAnimation(this, "Dropped Burst", this.reportIsOn(), this.traceIsOn());
		countUnsuccesful.createAnimation(new Position(370,600), new Form(), this.animationIsOn());
		
		packetsDropped = new CountAnimation(this, "PacketsDropped", this.reportIsOn(), this.traceIsOn());
		packetsDropped.createAnimation(new Position(270,600), (new Form(40,2)), this.animationIsOn());
		
		
		packetsProcessed= new CountAnimation(this, "PacketsProcessed", this.reportIsOn(), this.traceIsOn());
		packetsProcessed.createAnimation(new Position(530,600), new Form(), this.animationIsOn());
	...
	sourcenode = new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
		...
		bgElement = new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
			...
			bgElement3 = new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
					...
					BackgroundElement.TEXT_Style_Bold, 0, new Position(-170,-190), 
			...
			bgElement6 = new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
					...
					BackgroundElement.TEXT_Style_Bold, 0, new Position(80,-190), 
					new Form(180,400), Color.white, Color.black, this.animationIsOn());
			
			bgElement2= new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
					"NODE3 ", BackgroundElement.TEXT_POSITION_TopMiddle, BackgroundElement.TEXT_Size_Big, 
					BackgroundElement.TEXT_Style_Bold, 0, new Position(330,-190), 
					new Form(180,400), Color.white, Color.black, this.animationIsOn());
