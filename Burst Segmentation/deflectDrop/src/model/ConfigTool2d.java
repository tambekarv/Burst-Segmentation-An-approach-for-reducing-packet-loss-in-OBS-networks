...
public class ConfigTool2d {
	...
	/**
	 * Absolute path to model_data directory. Must end with /
	 */
	...
	public static String buildIconPath(String modelName){
		String out = "";
		out += new File("").getAbsolutePath() + File.separator + "model_data";
	...
	public static boolean createExperimentDir(String modelName, String experimentName){
		...
		modelDirStr += new File("").getAbsolutePath() + File.separator + "model_data";
