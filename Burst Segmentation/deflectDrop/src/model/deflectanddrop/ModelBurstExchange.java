...
import desmoj.extensions.visualization2d.animation.core.statistic.TimeSeriesAnimation;
...
public class ModelBurstExchange extends ModelAnimation {
	...
	protected final int[] CAPACITY_OF_CONTAINER_BLOCK = {1500, 1500, 1500};
	/** mean time for a container storage */
	protected final double CONTAINER_STORAGE_TIME = 10;
	/** initial fillings of the container blocks */
	protected final int[] INITIAL_FILLING = {750, 750, 750};
	
	protected final int[] PROD_CAP = {750, 750, 750};
	
	protected final int[] CONS_CAP = {750, 750, 750};
	/** mean number of import containers */
	protected final double MEAN_NUMBER_OF_IMPORTS = 0.5;
	/** mean inter-arrival time of trucks */
	protected final double MEAN_TRUCK_INTER_ARRIVAL_TIME = 1;
	...
	protected TimeSeriesAnimation trial;
Comment com;
...
private Point[] p;
	...
	private BackgroundElementAnimation bgElement16;
...
BackgroundElementAnimation[]	text2;
	...
	public void initAnimation() {
		...
		abc= new BackgroundElementAnimation(this, "trial1", null, "INPUT", 
					BackgroundElement.TEXT_POSITION_Middle, BackgroundElement.TEXT_Size_Normal,
					BackgroundElement.TEXT_Style_Bold, 0, new Position(-220,205), new Form(100, 29), 
		...
		*/
		...
		/*
		text = new BackgroundElementAnimation[500];
		for (int i=0; i< 500; i++)
		{
...
*/
		...
		*/
		...
		segQueue3 .createAnimation(	new Position(330,-49),
				new FormExt(true, 3, Burst.entityType.getId(),34,-20),
			this.animationIsOn());
		/*droppedafterdef = new ProcessQueueAnimation<Burst>(this, "Deflected Drop", 
				ProcessQueue.FIFO, 2000, this.reportIsOn(), this.traceIsOn());
		droppedafterdef .createAnimation(	new Position(-110,200),
				new FormExt(true, 3, Burst.entityType.getId(),34,-20),
			this.animationIsOn());
		*/
...
/****  v  *************************************************************************************/
		...
		count.createAnimation(new Position(160, 200), new Form(), this.animationIsOn());
		
		//packetsDroppedAfterSeg = new CountAnimation(this, " AfterSegmentation", this.reportIsOn(), this.traceIsOn());
		//packetsDroppedAfterSeg.createAnimation(new Position(450,-400), (new Form(40,2)), this.animationIsOn());
		
		countSuccesful = new CountAnimation(this, "BurstsProcessed", this.reportIsOn(), this.traceIsOn());
		countSuccesful.createAnimation(new Position(450,200), new Form(), this.animationIsOn());
		
		countUnsuccesful = new CountAnimation(this, "Dropped Burst", this.reportIsOn(), this.traceIsOn());
		countUnsuccesful.createAnimation(new Position(370,200), new Form(), this.animationIsOn());
		
		packetsDropped = new CountAnimation(this, "PacketsDropped", this.reportIsOn(), this.traceIsOn());
		packetsDropped.createAnimation(new Position(270,200), (new Form(40,2)), this.animationIsOn());
		
		
		packetsProcessed= new CountAnimation(this, "PacketsProcessed", this.reportIsOn(), this.traceIsOn());
		packetsProcessed.createAnimation(new Position(530,200), new Form(), this.animationIsOn());
		...
		this.arrivalSink			= new TransportStationAnimation(this, "  IncomingPort  ", new Position(-210,-135),this.animationIsOn());
		Position[] zp = new Position[2]; zp[0] = new Position(285,90); zp[1]= new Position(-210, 90);
		this.arrivalRoute			= new TransportRouteAnimation<Burst>(this, "Arrival Route", 5.0, 
		...
		this.arrivalSink2			= new TransportStationAnimation(this, null, new Position(130,-135),this.animationIsOn());
		Position[] zp1 = new Position[2]; zp1[0] = new Position(130,90); zp1[1]= new Position(130, 90);

		
		this.arrivalRoute2			= new TransportRouteAnimation<Burst>(this, "Arrival Route", 5.0, 
		...
		this.arrivalSink3			= new TransportStationAnimation(this, null, new Position(350,-135),this.animationIsOn());
		Position[] zp11 = new Position[2]; zp11[0] = new Position(350,90); zp11[1]= new Position(350, 90);

		
		this.arrivalRoute3			= new TransportRouteAnimation<Burst>(this, "Arrival Route", 5.0, 
	...
	/*	this.postdeflectsource		= new TransportStationAnimation(this, null, new Position(575,-20),this.animationIsOn());
		...
		*/
		...
		zp = new Position[3]; zp[0] = new Position(450,-49); zp[1]= new Position(450,20);zp[2]= new Position(-190,20);
		...
		// Route Abfahrt
		this.departureRoute			= new TransportRouteAnimation<Burst>(this, "Proccesed Bursts Output", 5, 
		...
		// Route Abfahrt
		this.departureRoute2			= new TransportRouteAnimation<Burst>(this, "Proccesed Bursts Output", 1, 
		...
		// Route Abfahrt
		this.departureRoute3			= new TransportRouteAnimation<Burst>(this, "Proccesed Bursts Output", 1, 
		...
		this.departureUnsuccesfulRoute	= new TransportRouteAnimation<Burst>(this, "Dropped Bursts Output", 1.0, 
		...
		this.departureUnsuccesfulRoute2	= new TransportRouteAnimation<Burst>(this, "Dropped Bursts Output", 1.0, 
		...
		this.departureUnsuccesfulRoute3	= new TransportRouteAnimation<Burst>(this, "Dropped Bursts Output", 5.0, 
	    ...
	    this.outputUnsuccesfulQueue.createAnimation(new Position(880,-185),
				   new FormExt(true, 1, Burst.entityType.getId(),90,-10),
				   this.animationIsOn());
	    this.droppedafterdef = new ProcessQueueAnimation<Burst>(this, "DroppedBursts(O/P)", this.reportIsOn(), this.traceIsOn());
	    this.droppedafterdef.createAnimation(new Position(40,200),
				   new FormExt(true, 1, Burst.entityType.getId(),90,-10),
				   this.animationIsOn());
...
/****  |  *************************************************************************************/
	...
	sourcenode = new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
		...
		bgElement = new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
			...
			bgElement2 = new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
					...
					BackgroundElement.TEXT_Style_Bold, 1, new Position(770,15), 
			...
			bgElement3 = new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
					...
					BackgroundElement.TEXT_Style_Bold, 1, new Position(-170,-190), 
					new Form(180,400), Color.white, Color.black, this.animationIsOn());
			...
			bgElement6 = new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
					...
					BackgroundElement.TEXT_Style_Bold, 1, new Position(80,-190), 
					new Form(180,400), Color.white, Color.black, this.animationIsOn());
			
			bgElement2= new BackgroundElementAnimation(this, "NODE1-Set of WaveLength", null,  
					"NODE3 ", BackgroundElement.TEXT_POSITION_TopMiddle, BackgroundElement.TEXT_Size_Big, 
					BackgroundElement.TEXT_Style_Bold, 1, new Position(330,-190), 
					new Form(180,400), Color.white, Color.black, this.animationIsOn());
			...
			//trial = new TimeSeries(this, "Trial", "trial1.txt", simBegin, simEnd, false);
			this.trial = new TimeSeriesAnimation(this, "Trial123", simBegin, simEnd, this.traceIsOn());
			//this.trial.createAnimation(new Position(1000,200), new Form(), this.animationIsOn());
			
			this.trial.startRecordingValues();
	...
	public static void main(String[] args) {
	   ...
	   // Initialisierung der CmdGeneration für Animation (neu Hinzugefügt)
		...
		//Plotter plotter = new Plotter(ConfigTool2d.buildOutputPath(modelName, expName), new Dimension(1000, 1500));
		TimeInstant simBegin, simEnd;
	    simBegin = new TimeInstant(new GregorianCalendar(2014, Calendar.JANUARY, 1, 10, 00));
	    simEnd 	 = new TimeInstant(new GregorianCalendar(2014, Calendar.JANUARY, 2, 10, 00));
		...
		cmdGen.close();
		//
		//plotter.makeTimeSeriesPlot(model.trial, false);
